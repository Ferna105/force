...
const QUEST_PLACES = [
  ...
  },
  {
    ...
    description: 'Estanterías ordenadas por letra, repletas de tratados de herbología, bestiarios, recetarios y diarios de cosecha. El saber de generaciones acumulado en lomos gastados; quién sabe qué secretos esperan entre tanto papel.',
  },
  {
    name: 'Estelas de la Guerra Antigua', region: 'Meseta de la Guerra Antigua', biome: 'arid', hotspot: { x: 58, y: 40 },
    description: 'En lo alto de la meseta sobreviven dos inscripciones de piedra, talladas en una lengua que pocos saben leer. Quien la entiende descubre el eco de una guerra que terminó en silencio.',
  },
  {
    name: 'Telescopio Ancestral', region: 'Cumbre Helada', biome: 'snow', hotspot: { x: 76, y: 18 },
    description: 'En la cima de la Cumbre Helada, un telescopio milenario escruta el vacío. Pocos han sabido leer lo que el cielo esconde… y menos aún, cuándo mirarlo.',
  },
];
...
const DEO_EVENT = {
  ...
  steps: [
    { key: 'visit_npc', type: 'visit_place', params: { placeName: 'Una criatura extraña' }, label: 'Algo cayó del cielo sobre las arenas grises. Buscalo.' },
    ...
    { key: 'use_ship', type: 'flag', label: 'Con la pieza hallada, devolvele el aliento a la nave.' },
    { key: 'read_final', type: 'flag', label: 'Aquella lengua guardaba una última verdad. Volvé a leerla.' },
    { key: 'train_strength', type: 'raise_stat_in_training', params: { stat: 'strength' }, label: '«Solo un emergente fuerte lo logrará.» Volvete fuerte.' },
    { key: 'telescope', type: 'telescope', params: { fromHour: 21, toHour: 23, coordinates: DEO_COORDS }, label: 'El rumbo está escrito en el cielo. Pero el sol lo esconde.' },
    { key: 'travel', type: 'answer', params: { answer: DEO_COORDS }, label: 'Tenés el rumbo. Marcalo y partí hacia lo desconocido.' },
  ],
